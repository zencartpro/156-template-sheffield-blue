 ...
 * @version $Id: layout_controller.php for Sheffield Blue 2019-08-20 15:39:11Z webchills $
 */
...
//        $warning_new_box .= $file . ' - HIDDEN ';
    ...
    $db->Execute("INSERT INTO " . TABLE_LAYOUT_BOXES . " (layout_template, layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single, show_box_min_width)
    ...
    case 'save':
      ...
      $db->Execute("UPDATE " . TABLE_LAYOUT_BOXES . "
                    SET layout_box_status = " . (int)$layout_box_status . ",
                        ...
                        show_box_min_width = '" . (int)($show_box_min_width) . "'
        ...
        foreach ($reset_boxes as $reset_box) {
          ...
          $db->Execute("UPDATE " . TABLE_LAYOUT_BOXES . "
                        SET layout_box_status = " . (int)$reset_box['layout_box_status'] . ",
                            ...
                            show_box_min_width = " . (int)$reset_box['show_box_min_width'] . "
          ...
          <table class="table table-hover">
            <thead>
              <tr class="dataTableHeadingRow">
                ...
                <?php // bof sheffield blue template ?>				
                <th class="dataTableHeadingContent text-center"><font color="#0044cc"><?php echo 'Show Box @ Min-Width'; ?></font></th>
                <?php // eof sheffield blue template ?>
            ...
            <tbody>
              ...
              <?php
              // bof sheffield blue template
              $column_controller = $db->Execute("SELECT layout_id, layout_box_name, layout_box_status, layout_box_location, layout_box_sort_order, layout_box_sort_order_single, layout_box_status_single, show_box_min_width
                                                 FROM " . TABLE_LAYOUT_BOXES . "
...
//  if ( (is_object($bInfo)) && ($column_controller->fields['layout_id'] == $bInfo->layout_id) ) {
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 configurationColumnRight">
            ...
            case '0': $show_box_min_width_on = false; 
              $show_box_min_width_off = true; 
              break;
            case '1':
            default: $show_box_min_width_on = true;
             $show_box_min_width_off = false;
            }
            // eof sheffield blue template
